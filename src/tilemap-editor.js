      ...
      <div class="card_body">
        ...
        <details style="display: none; visibility: hidden;" class="details_container sticky_left" id="tilesetDataDetails" open="true">
          ...
          <div style="display: none; visibility: hidden;">
            ...
            <div style="display: flow; height: 70px; border-radius: 6px; padding-top: 8px; background-color: #28344290;"  class="select_container layer sticky_top sticky_left"  id="mapSelectContainer" style="margin-bottom: 5px">
            ...
            <button style="cursor: default;" id="removeTilesetBtn" title="⚠️ delete this tileset ⚠️">🗑️</button>
                ...
                <div title="Tile Category" style="margin-top: 5px;">
                  <button style="border-color: #283442; border-radius: 3px; background-color: #283442;" onclick="document.getElementById('card_left_column_alt').scrollTo(0,100);">1️⃣</button>
                  <button style="border-color: #283442; border-radius: 3px; background-color: #283442;" onclick="document.getElementById('card_left_column_alt').scrollTo(0,200);">2️⃣</button>
                  <button style="border-color: #283442; border-radius: 3px; background-color: #283442;" onclick="document.getElementById('card_left_column_alt').scrollTo(0,300);">3️⃣</button>
                  
                  <button style="border-color: #283442; border-radius: 3px; background-color: #283442;" onclick="document.getElementById('card_left_column_alt').scroll(0,400);">4️⃣</button>
                  <button style="border-color: #283442; border-radius: 3px; background-color: #283442;" onclick="document.getElementById('card_left_column_alt').scroll(0,500);">5️⃣</button>
                  <button style="border-color: #283442; border-radius: 3px; background-color: #283442;" onclick="document.getElementById('card_left_column_alt').scroll(0,600);">6️⃣</button>
                </div> 
            </div>
